...
export const metalSections: SectionDef[] = [
  {
    key: 'whatItIs',
    heading: 'What it is',
    keywords: ['introduction', 'overview', 'priority', 'contaminant', 'what it is'],
  },
  {
    key: 'whereItShowsUp',
  ...
  },
  {
    ...
    keywords: ['key data', 'evidence summary', 'food categories', 'highest-risk', 'high risk'],
  },
  {
    key: 'testingNotes',
