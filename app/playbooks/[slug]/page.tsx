...
export default async function PlaybookPage({ params }: { params: { slug: string } }) {
  ...
  return <ArticleShell title={page.title} description={page.description} meta={<p className="muted">Updated {page.updatedAt}</p>} html={page.html} contentType="playbooks" slug={params.slug} />;
}
