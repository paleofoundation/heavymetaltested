...
export default async function NewsPostPage({ params }: { params: { postSlug: string } }) {
  ...
  return <ArticleShell title={page.title} description={page.description} meta={<p className="muted">Published {page.publishedAt}{page.updatedAt ? ` · Updated ${page.updatedAt}` : ''}</p>} html={page.html} contentType="news" slug={params.postSlug} />;
}
