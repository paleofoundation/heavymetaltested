...
export default async function CategoryPage({ params }: { params: { categorySlug: string } }) {
  ...
  return <ArticleShell title={page.title} description={page.description} meta={<p className="muted">Updated {page.updatedAt}</p>} html={page.html} contentType="categories" slug={params.categorySlug} />;
}
