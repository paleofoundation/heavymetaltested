...
export default async function MechanismPage({ params }: { params: { topicSlug: string } }) {
  ...
  return <ArticleShell title={page.title} description={page.description} meta={<p className="muted">Updated {page.updatedAt}</p>} html={page.html} contentType="mechanisms" slug={params.topicSlug} />;
}
